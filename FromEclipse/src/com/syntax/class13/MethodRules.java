...
public class MethodRules {
	...
	public static void main(String[] args) {
		/*
		 * 
		 * The return type is the must in a method, 
		 * you can't declare the method without it's return type.
		 ...
		 * ●You can't declare more than one return statement in one method unless using if condition.
